...
class ApiCaller(object):
    ...
    def _validate_optional_params(self, resource, optional_params):
        ...
        for param in optional_params:
            if param not in optional_params_keys:
                raise ValueError(
                    "Optional parameter '{param}' not valid for resource '{resource}'".format(
                        param=param, resource=resource
                    )
                )
    ...
    def _get_request(self, full_url, optional_params=None):
        ...
        response = requests.get(
            full_url, headers=headers, params=optional_params, timeout=self.timeout
        )
        return response
    ...
    def fetch(self, resource, *args, **kwargs):
        ...
        if not positional_args == "":
            ...
            full_url = "{base_url}/{resource}/{positional_args}".format(
            ...
            full_url = "{base_url}/{resource}".format(
                base_url=self.base_url, resource=resource
            )
...
class CivicEngineApi(ApiCaller):
    ...
    resource_optional_params_map = {
        ...
        POSITIONS_RESOURCE: (
            ...
            "include_uncertified_candidates",
    ...
    def get_candidate(self, candidate_id, optional_params=None):
        ...
        """
        result = self.fetch(
            self.CANDIDATE_RESOURCE, candidate_id, optional_params=optional_params
        )
    ...
    def get_normalized_positions(self, optional_params=None):
        ...
        """
        result = self.fetch(
            self.NORMALIZED_POSITIONS_RESOURCE, optional_params=optional_params
        )
        # return the tuple (success, json)
        return result
    ...
    def get_office_holders(self, optional_params=None):
        ...
        """
        result = self.fetch(
            self.OFFICE_HOLDERS_RESOURCE, optional_params=optional_params
        )
        # return the tuple (success, json)
        return result
    ...
    def get_polling_places(self, optional_params=None):
        ...
        """
        result = self.fetch(
            self.POLLING_PLACES_RESOURCE, optional_params=optional_params
        )
        # return the tuple (success, json)
        return result
