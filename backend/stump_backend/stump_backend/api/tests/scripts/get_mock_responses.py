...
def load_civic_engine_mock_success_response(data_dir: str=TEST_DATA_DIR, filename: str='mock_success_response.pkl') -> None:
    url = 'https://api.civicengine.com/positions'
    headers = {
        'x-api-key': os.environ.get('CIVICENGINE_API_KEY')
    }
    params = {
